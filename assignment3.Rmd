...
```
All code included in this assignment is available in a GitHub repository at https://github.com/mworlidge/incomplete-data-analysis/blob/main.R. First I need to load all the necessary packages.
